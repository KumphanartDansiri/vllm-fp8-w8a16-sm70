#!/usr/bin/env bash
# Load + serve 122B-A10B-FP8 WITH MTP (TP=8, ns=8 cudagraph). Runs in FOREGROUND.
# When you see "Application startup complete", run tools/hl_measure_122b_mtp.sh
...
MODEL=/mnt/models/Qwen3.5-122B-A10B-FP8 PORT=8002 GPUS=0,1,2,3,4,5,6,7 TP_SIZE=8 ENABLE_QWEN_MTP=1 \
  ./tools/bench_v100.sh serve hl_122b_mtp
