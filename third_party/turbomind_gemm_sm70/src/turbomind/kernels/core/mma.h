...
#include <cassert>
#include <cuda_bf16.h>  // V100 PATCH (from 1catai, Apache-2.0): bf16 mma overloads need
                        // __nv_bfloat16 defined in a standalone build (else <error-type>
                        // ambiguity in sm70_884_*.cu). See PROVENANCE.md.
